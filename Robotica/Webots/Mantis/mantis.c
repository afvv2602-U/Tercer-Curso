...
int main(int argc, char **argv) {
  ...
  // amplitude [rad]
  const double aC = 0.5;  // Amplitude for the "base" motors.
  const double aF = 0.80;   // Amplitude for the "shoulder" motors.
  const double aT = 0.5;  // Amplitude for the "knee" motors.
